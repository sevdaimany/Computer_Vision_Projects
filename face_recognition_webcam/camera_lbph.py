...
face_detector = cv2.CascadeClassifier('D:\\ML\computer vision projects\\face_recognition_webcam\\haarcascade_frontalface_default.xml')
face_recognizer = cv2.face.LBPHFaceRecognizer_create()
face_recognizer.read('D:\\ML\\computer vision projects\\face_recognition_webcam\\lbph_classifier.yml')


width, height = 220, 220
font = cv2.FONT_HERSHEY_COMPLEX_SMALL

# 0 means we want video from webcam
